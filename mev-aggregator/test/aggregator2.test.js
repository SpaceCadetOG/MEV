...
const USDC_WHALE = "0x9f8c163cBA728e99993ABe7495F06c0A3c8Ac8b9"; // find whale on etherscan => Look for exchanges like FTX || Binacne || Coinbase
const DAI = "0xd586E7F844cEa2F87f50152665BCbc2C279D8d70";
const DAI_WHALE = "0x702f7741A77b763e691c0a35e04448f1bf1c7bEB";

describe("AggregatorContract2", function () {
  async function deployOneYearLockFixture() {
    const [owner, user1] = await ethers.getSigners();
    const Aggregator = await ethers.getContractFactory("Aggregator2");
